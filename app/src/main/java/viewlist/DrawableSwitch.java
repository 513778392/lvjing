...
public class DrawableSwitch extends View
{
    ...
    //左圆圆心和右圆圆心中间的坐标
    private int mid_x;
    int yanse = 0xFFFEE300;
    public DrawableSwitch(Context context) {
        this(context, null);
    }

    public DrawableSwitch(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DrawableSwitch(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
